...
def build_main(tickers, prices):
    ...
    # Ajuste do layout das métricas em uma única coluna para telas menores
    mygrid = grid(1, vertical_align="top")
    for t in prices.columns:
        c = mygrid.container(border=True)
        c.subheader(t, divider="red")
        colA, colB, colC = c.columns([1, 1, 1])
        if t == "portfolio":
    ...
    # Ajuste para exibir gráficos em colunas empilhadas em telas menores
